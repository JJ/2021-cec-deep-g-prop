...
GProp and DeepGProp using the following configuration: initial population of
...
DeepGProp. When increasing significantly the problem size, we find a better
...
DeepGProp algorithm, it seems the optimizer finds a local minimum when the
