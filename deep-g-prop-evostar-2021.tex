...
generator seeds ( \code{2017725297}, \code{3842001146}, \code{788305541},
\code{1367677890}, and \code{3074644809}. We obtained these seeds using the
\code{getrandbits} function from the \code{random} module found in Python's
standard library.
