...
\cite{castilloNC,CastilloNPL}: % [pedro]  it makes no sense including that citation that takes you to the paper in the journal web page. Instead, we should cite   \cite{castilloNC,CastilloNPL}
...
To compare our results against the GProp algorithm we selected the Proben1 \cite{Proben1}
